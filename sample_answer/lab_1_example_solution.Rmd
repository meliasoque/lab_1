...
\begin{quotation}\textit{Was fear or anger more effective at causing voters to turn out in the 2018 election?}\end{quotation}
...
Our analysis leverages data from the 2018 American National Election Studies (ANES).  This is an observational dataset, based on a sample of respondents drawn from the YouGov platform. The Yougov panel is not nationally representative, and consists of participants who sign up to complete questionnaires in exchange for rewards.
